...
public class SignupPage {
    ...
    public void signup(String firstName, String lastName, String username, String password) {
        ...
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", firstNameField);
        ((JavascriptExecutor) driver).executeScript("arguments[0].value='" + firstName + "';", firstNameField);
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", lastNameField);
        ((JavascriptExecutor) driver).executeScript("arguments[0].value='" + lastName + "';", lastNameField);
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", usernameField);
